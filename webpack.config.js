...
// "ecdsa-koblitz-signature-2016s" library but with
// different content
const outputs = [
  // core ecdsa-koblitz-signature-2016s library
  {
    entry: [
    ...
    filenameBase: 'ecdsa-koblitz-signature-2016'
  },
  /*
...
outputs.forEach(info => {
  ...
  const common = {
    ...
    entry: {
      'ecdsa-koblitz-signature-2016': info.entry
    },
    module: {
      rules: [
        {
